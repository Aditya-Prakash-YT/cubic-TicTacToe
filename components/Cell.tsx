...
export const Cell: React.FC<CellProps> = ({ value, onClick, isWinningCell, disabled, isLastMove }) => {
  ...
  if (value === 'X') {
    colorClasses = "bg-slate-800 border-cyan-500 text-cyan-400 shadow-[0_0_15px_rgba(34,211,238,0.4)]";
  } else if (value === 'O') {
    colorClasses = "bg-slate-800 border-rose-500 text-rose-400 shadow-[0_0_15px_rgba(251,113,133,0.4)]";
  }

  if (isWinningCell) {
    // Override for winner
    if (value === 'X') {
        colorClasses = "bg-cyan-900/50 border-cyan-400 text-cyan-100 scale-110 shadow-[0_0_20px_rgba(34,211,238,0.8)] z-10";
    } else {
        colorClasses = "bg-rose-900/50 border-rose-400 text-rose-100 scale-110 shadow-[0_0_20px_rgba(251,113,133,0.8)] z-10";
    }
